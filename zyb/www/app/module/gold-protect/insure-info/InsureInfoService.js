 ...
 */
angular.module('app.services').factory('goldProtectInsureInfoService', function (NetworkService, AppConfig, goldProtectService) {
    return {
        /**
         * 投保
        ...
        insure: function (policyHolder, insured, address, insurancePeriod, baseInfo) {
            var productInfo = goldProtectService.getProduct(); // 获取产品信息
            var instanceInfo = goldProtectService.getInstance();
            ...
            // 保存投保信息
            goldProtectService.setInsureInfo(insureObj);
        ...
        getSelectedProduct: function () {
            return goldProtectService.getProduct();
        }
    }
});