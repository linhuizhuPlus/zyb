 ...
 */
angular.module('app.services').factory('SafeCookInsureInfoService', function (NetworkService, AppConfig, SafeCookService) {
    return {
        /**
         * 投保
        ...
        insure: function (policyHolder, insured, address, insurancePeriod, baseInfo) {
            var productInfo = SafeCookService.getProduct(); // 获取产品信息
            var instanceInfo = SafeCookService.getInstance();
            ...
            // 保存投保信息
            SafeCookService.setInsureInfo(insureObj);
        ...
        getSelectedProduct: function () {
            return SafeCookService.getProduct();
        }
    }
});