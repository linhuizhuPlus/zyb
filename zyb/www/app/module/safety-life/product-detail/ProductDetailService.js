 ...
 */
angular.module('app.services').factory('ProductDetailService', function (NetworkService, AppConfig, SafetyLifeService) {
    return {
        /**
         * 根据产品代码获取产品详情
        ...
        getProductDetail: function (productCode) {
            return NetworkService.httpExecute(angular.extend({
                ...
                if (response && response.success) {
                    // 暂存所有产品信息
                    SafetyLifeService.setInstance(response.data);
        ...
        setSelectedProduct: function (product) {
            SafetyLifeService.setProduct(product);
        }
    } 
});